...
#' @importFrom flextable information_data_chunk
...
#' @importFrom gtsummary modify_column_alignment
#' @importFrom gtsummary modify_column_merge
...
#' @importFrom gtsummary remove_abbreviation
...
#' @importFrom openxlsx2 wb_get_base_font
